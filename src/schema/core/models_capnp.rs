...
pub mod timestamp {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_nseconds(&mut self, value: u64)  {
  ...
  mod _private {
    ...
    pub const TYPE_ID: u64 = 0xb381_ba78_57e5_aea9;
  }
}
...
pub mod result { /* T */
  ...
  impl <'a,T> Builder<'a,T> where T: for<'c> ::capnp::traits::Owned<'c>  {
    ...
    #[inline]
    pub fn set_error(&mut self, value: crate::schema::core::errors_capnp::error::Reader<'_>) -> ::capnp::Result<()> {
      self.builder.set_data_field::<u16>(0, 1);
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(0), value, false)
    }
    #[inline]
    pub fn init_error(self, ) -> crate::schema::core::errors_capnp::error::Builder<'a> {
      self.builder.set_data_field::<u16>(0, 1);
  ...
  mod _private {
    ...
    pub const TYPE_ID: u64 = 0xb85f_8a64_bef8_544d;
  }
  pub enum Which<A0,A1> {
    Value(A0),
    Error(A1),
  }
  pub type WhichReader<'a,T> = Which<::capnp::Result<<T as ::capnp::traits::Owned<'a>>::Reader>,::capnp::Result<crate::schema::core::errors_capnp::error::Reader<'a>>>;
  pub type WhichBuilder<'a,T> = Which<::capnp::Result<<T as ::capnp::traits::Owned<'a>>::Builder>,::capnp::Result<crate::schema::core::errors_capnp::error::Builder<'a>>>;
}
...
pub mod boolean_result {
  ...
  mod _private {
    use capnp::private::layout;
    pub const STRUCT_SIZE: layout::StructSize = layout::StructSize { data: 1, pointers: 1 };
    pub const TYPE_ID: u64 = 0x82cf_29d7_e6ef_adc3;
  }
  pub enum Which<A0> {
    Value(bool),
    Error(A0),
  }
  pub type WhichReader<'a,> = Which<::capnp::Result<crate::schema::core::errors_capnp::error::Reader<'a>>>;
  pub type WhichBuilder<'a,> = Which<::capnp::Result<crate::schema::core::errors_capnp::error::Builder<'a>>>;
}
